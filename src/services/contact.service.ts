...
import type { ContactFormData } from '../../schemas/contact.schema.js';
...
export class ContactService {
  ...
  // Submit contact form
static async submitContactForm(contactData: ContactFormData) {
  // Create message in database
  const message = await prisma.message.create({
  ...
  static async getAllMessages(page: number = 1, limit: number = 20, filters?: {
    isRead?: boolean;
    isResolved?: boolean;
    search?: string;
  }) {
